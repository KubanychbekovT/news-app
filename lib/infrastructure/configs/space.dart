...
class Space {
  ...
  static void init() {
    ...
    y1 = SizedBox(width: AppDimensions.space());

    x2 = SizedBox(width: AppDimensions.space(2));
    y2 = SizedBox(width: AppDimensions.space(2));
  ...
  static EdgeInsets vf([double no = 1]) => EdgeInsets.symmetric(vertical: AppDimensions.space(no),
  );
